...
BOT_NAME = getenv("BOT_NAME", "GPL Music")
...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "ithunammaserial_chat")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "ithunamacinema")
OWNER_NAME = getenv("OWNER_NAME", "gpl_kavin") # isi dengan username kamu tanpa simbol @
